...
public class ConversationActivity extends XmppActivity
    ...
    private FloatingActionButton addConversationButton;
    ...
    public void showConversationsOverview() {
        if (mContentView instanceof FrameLayout) {
            ...
            FrameLayout frameLayout = (FrameLayout) mContentView.findViewById(R.id.list_field);
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        addConversationButton = (FloatingActionButton) findViewById(R.id.add_conversation);
        addConversationButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("case", R.id.action_add);
    ...
    private void updateHeaderView() {
        ...
        ImageView imgAvatar = (ImageView) header.findViewById(R.id.account_image);

        if (xmppConnectionService.getAccounts().size() > 0) {
            Account account = xmppConnectionService.getAccounts().get(0);
            userName.setText(account.getUsername());
            imgAvatar.setImageBitmap(avatarService().get(account, getPixel(192)));
        }
    }
    ...
    public void initNavigationDrawer() {
            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                ...
                switch (id) {
                    ...
                    case R.id.action_add_secure_conversation:
                        drawerLayout.closeDrawers();
                        intent.putExtra("case", R.id.action_add_secure_conversation);
                        startActivity(intent);
                        break;
                    case R.id.action_create_conference:
                        drawerLayout.closeDrawers();
                        intent.putExtra("case", R.id.action_create_conference);
                        startActivity(intent);
                        break;
                    case R.id.action_settings:
                        drawerLayout.closeDrawers();
                        startActivity(new Intent(ConversationActivity.this, SettingsActivity.class));
                        break;
                    ...
                    case R.id.action_accounts:
                        drawerLayout.closeDrawers();
                        startActivity(new Intent(ConversationActivity.this, ManageAccountActivity.class));
                        break;
                }
                return true;
            }
        ...
        View header = navigationView.getHeaderView(0);
        ImageView avatar = (ImageView) header.findViewById(R.id.account_image);
        ...
        /*MenuItem menuSecure = navigationView.getMenu().getItem(R.id.action_add_secure_conversation);
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            menuSecure.setIcon(R.drawable.ic_lock_white_24dp);
        } else {
            menuSecure.setIcon(R.drawable.ic_action_secure);
        ...
        ActionBarDrawerToggle actionBarDrawerToggle = new ActionBarDrawerToggle(
                ConversationActivity.this, drawerLayout, R.string.drawer_open, R.string.drawer_close) {
